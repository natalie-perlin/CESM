...
!-----------------------------------------------------------------------
   ...
   call define_tavg_field(tavg_TAUX_2,'TAUX_2',2,                     & !rwpayne start
                          long_name='Windstress in grid-x direction', &
                          units='dyne/centimeter^2', grid_loc='2220', &
                          coordinates='ULONG ULAT time')                 !rwpayne end 
   ...
   call define_tavg_field(tavg_TAUY_2,'TAUY_2',2,                     & !rwpayne start
                          long_name='Windstress in grid-y direction', &
                          units='dyne/centimeter^2', grid_loc='2220', &
                          coordinates='ULONG ULAT time')                 !rwpayne end           
...
!-----------------------------------------------------------------------
   ...
   do iblock = 1,nblocks_clinic
      ...
      call accumulate_tavg_field(SMF(:,:,1,iblock), tavg_TAUX_2,iblock,1) !rwpayne
      call accumulate_tavg_field(SMF(:,:,1,iblock)**2, tavg_TAUX2,iblock,1)
      call accumulate_tavg_field(SMF(:,:,2,iblock), tavg_TAUY,iblock,1)
      call accumulate_tavg_field(SMF(:,:,2,iblock), tavg_TAUY_2,iblock,1) !rwpayne
